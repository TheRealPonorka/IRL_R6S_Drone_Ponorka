...
// Balance PID (angle control). Soft values for an unloaded breadboard motor.
#define PID_BALANCE_KP 12.0f
#define PID_BALANCE_KI 0.0f
#define PID_BALANCE_KD 0.45f
#define PID_BALANCE_SETPOINT 0.0f  // Overwritten at warmup / Set level
#define BALANCE_DEADBAND_DEG 3.0f
#define BALANCE_WARMUP_MS 1500
