...
#define MOTOR_A_PIN1 8       // Motor A Forward (Safe PWM pin)
#define MOTOR_A_PIN2 9       // Motor A Reverse (Safe PWM pin)
#define MOTOR_B_PIN1 10      // Motor B Forward (Safe PWM pin)
#define MOTOR_B_PIN2 11      // Motor B Reverse (Safe PWM pin)

// Motor PWM settings
#define MOTOR_PWM_FREQ 20000    // 20kHz PWM frequency
#define MOTOR_PWM_RESOLUTION 8  // 8-bit resolution (0-255)
#define MOTOR_PWM_CHANNEL_A1 0
...
#define ENCODER_LEFT_A_PIN 12   // Left motor encoder A (Safe interrupt pin)
#define ENCODER_LEFT_B_PIN 13   // Left motor encoder B (Safe interrupt pin)  
#define ENCODER_RIGHT_A_PIN 18  // Right motor encoder A (Safe interrupt pin)
#define ENCODER_RIGHT_B_PIN 19  // Right motor encoder B (Safe interrupt pin)
...
#define SPOTLIGHT_PIN 47     // Gate/Base driver pin (Safe PWM pin)
